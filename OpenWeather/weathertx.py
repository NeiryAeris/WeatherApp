...
def get_hourly_weather():
    ...
    popup.geometry("670x150")
    popup.resizable(False,False)
    popup.configure(bg="#212120")
    sub1_sector = Label(popup, image=sub_img, border=1)
    sub2_sector = Label(popup, image=sub_img, border=1)
    sub3_sector = Label(popup, image=sub_img, border=1)
    sub4_sector = Label(popup, image=sub_img, border=1)
    sub5_sector = Label(popup, image=sub_img, border=1)
    sub6_sector = Label(popup, image=sub_img, border=1)

    
    sub1_sector.place(x=10,y=10)
    sub2_sector.place(x=120,y=10)
    sub3_sector.place(x=230,y=10)
    sub4_sector.place(x=340,y=10)
    sub5_sector.place(x=450,y=10)
    sub6_sector.place(x=560,y=10)
    
    weat_data = read_data(file_name)

    #start sub1_sector
    global sub1_icon
    sub1_sect_icon_id = weat_data["hourly"][0]["weather"][0]["icon"]
    ...
    #start sub2_sector
    global sub2_icon
    sub2_sect_icon_id = weat_data["hourly"][1]["weather"][0]["icon"]
    ...
    #start sub3_sector
    global sub3_icon
    sub3_sect_icon_id = weat_data["hourly"][2]["weather"][0]["icon"]
    ...
    #start sub4_sector
    global sub4_icon
    sub4_sect_icon_id = weat_data["hourly"][3]["weather"][0]["icon"]
    ...
    date_time=dt[11:16]
    time=Label(sub6_sector, text=date_time,  bg="#203243", fg="white", font=("Helvetica",10,'bold')).place(x=25,y=5)
    temperature = int(weat_data["hourly"][5]["temp"]) - 273.15
    temp = Label( sub6_sector, text=f"Temp: {str(temperature)[:4]}°C", bg="#203243", fg="white", font=("Helvetica",10))
    temp.place(x=0, y=60)
    humidity = weat_data["hourly"][5]["humidity"]
    humid = Label(sub6_sector, text=f"Humid: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10))
    humid.place(x=0, y=80)
    description = weat_data["hourly"][5]["weather"][0]["description"]
    descript = Label( sub6_sector, text=f"{description}", bg="#203243", fg="white", font=("Helvetica",9))
    descript.place(x=0, y=100)
    #end sub6_sector
...
hourly_text=Label(weather_sector, text="To see hourly weather click ", bg="#203243", fg="white", font=("Helvetica",9))
hourly_button = Button(weather_sector,borderwidth=0,text="Here",font=("Helvetica",9),width=8,height=2,bg="#203243",command=get_hourly_weather)
...
hourly_button.place(x=212,y=110)
hourly_text.place(x=50,y=125)

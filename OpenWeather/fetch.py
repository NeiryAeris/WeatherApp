...
def fetching():
    OpenWeatherAPI.get_data(textfield.get())
...
search_button=Button(search_box,image=search_icon, borderwidth=0,cursor="hand2",bg="#203243",command=fetching)
...
feels = Label(
    weather_sector, text=f"Feels like: {str(feels_like)[:4]}°C", bg="#203243", fg="white", font=("Helvetica",10)
)
feels.place(x=10, y=30)

humidity = weat_data["current"]["humidity"]
humid = Label(
    weather_sector, text=f"Humidity: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=10, y=50)

description = weat_data["current"]["weather"][0]["description"]
descript = Label(
    weather_sector, text=f"Overall: {description}", bg="#203243", fg="white", font=("Helvetica",10)
)
...
humidity = weat_data["current"]["humidity"]
humid = Label(
    main_sector, text=f"Humidity: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=10, y=50)

description = weat_data["current"]["weather"][0]["description"]
descript = Label(
    main_sector, text=f"Overall: {description}", bg="#203243", fg="white", font=("Helvetica",10)
)
descript.place(x=10, y=70)
#end main_sector
...
temp = Label(
    sub1_sector, text=f"Temp: {str(temperature)[:4]}°C", bg="#203243", fg="white", font=("Helvetica",10)
)
temp.place(x=0, y=60)
humidity = weat_data["daily"][0]["humidity"]
humid = Label(
    sub1_sector, text=f"Humid: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=0, y=80)

description = weat_data["daily"][0]["weather"][0]["description"]
descript = Label(
    sub1_sector, text=f"{description}", bg="#203243", fg="white", font=("Helvetica",9)
)
...
temp = Label(
    sub2_sector,
    text=f"Temp: {str(temperature)[:4]}°C", bg="#203243", fg="white", font=("Helvetica",10)
)
temp.place(x=0, y=60)
humidity = weat_data["daily"][1]["humidity"]
humid = Label(
    sub2_sector, text=f"Humid: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=0, y=80)

description = weat_data["daily"][1]["weather"][0]["description"]
descript = Label(
    sub2_sector, text=f"{description}", bg="#203243", fg="white", font=("Helvetica",9)
)
descript.place(x=0, y=100)
#end sub2_sector
...
humid = Label(
    sub3_sector, text=f"Humid: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=0, y=80)

description = weat_data["daily"][2]["weather"][0]["description"]
descript = Label(
    sub3_sector, text=f"{description}", bg="#203243", fg="white", font=("Helvetica",9)
)
descript.place(x=0, y=100)
#end sub3_sector
...
humid = Label(
    sub4_sector, text=f"Humid: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=0, y=80)

description = weat_data["daily"][3]["weather"][0]["description"]
descript = Label(
    sub4_sector, text=f"{description}", bg="#203243", fg="white", font=("Helvetica",9)
)
descript.place(x=0, y=100)
#end sub4_sector
...
humid = Label(
    sub5_sector, text=f"Humid: {humidity}%", bg="#203243", fg="white", font=("Helvetica",10)
)
humid.place(x=0, y=80)

description = weat_data["daily"][4]["weather"][0]["description"]
descript = Label(
    sub5_sector, text=f"{description}", bg="#203243", fg="white", font=("Helvetica",9)
)
descript.place(x=0, y=100)
#end sub5_sector

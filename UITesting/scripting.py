#this file is not the main file, pls be caution
from tkinter import *
...
button_text = f"""Temperature: {str(temperature)[:4]}°C
Feels like: {str(feels_like)[:4]}°C
Humidity: {humidity}%
Overall: {description}"""

a_button = Button(main_sector, text=button_text, image=display_icon('10d'),compound= LEFT,height=10,width=30)
a_button.pack()
